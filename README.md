...
![Version](https://img.shields.io/badge/Version-2.290-white)

# Fast PHP Page Module
## Documentation for Bugfish-Framework integrated in FP2

This module integrated the documentation for the bugfish-framework into the fast-php-page cms, so you can always look it up if you need it!
